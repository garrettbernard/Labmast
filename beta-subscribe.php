...
<html>
	<head>
        <title>Labmast Beta</title>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        <meta name="description" content="Labmast Beta Email Forms">
        <meta name="keywords" content="Labmast Beta">
...
<form action="http://labmast.us4.list-manage1.com/subscribe/post" method="POST">
<input type="hidden" name="u" value="2e613a3dcbcd2fc6e7995d26b">
<input type="hidden" name="id" value="80a6869c48">
...
<div class="mergeRow dojoDndItem mergeRow-radio" id="mergeRow-4">
<label for="MERGE4">Are you currently a high school or collegiate laboratory instructor?</label>
<div class="field-group">

    <ul class="interestgroup_field" id="MERGE4"><li><input type="radio" name="MERGE4" id="MERGE4-0" value="Yes"> <label for="MERGE4-0">Yes</label></li><li><input type="radio" name="MERGE4" id="MERGE4-1" value="No"> <label for="MERGE4-1">No</label></li></ul>
...
<input type="submit" class="button" name="submit" value="Subscribe">
		...
		<div class="poweredWrapper">
			...
			<span class="poweredBy"><a href="http://www.mailchimp.com/monkey-rewards/?aid=2e613a3dcbcd2fc6e7995d26b&afl=1"><img src="http://gallery.mailchimp.com/089443193dd93823f3fed78b4/images/postmark_mailchimp_red.gif" border="0" alt="Email Marketing Powered by MailChimp" title="MailChimp Email Marketing"></a></span>
		</div>
